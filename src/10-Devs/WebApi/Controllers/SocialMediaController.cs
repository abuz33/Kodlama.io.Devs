...
public class SocialMediaController : BaseController
{
    ...
    {
        var result = await Mediator.Send(new GetSocialMediaListQuery() { PageRequest = pageRequest });
        return Ok(result);
    }

    [HttpGet("{Id}")]
    public async Task<IActionResult> Get ([FromRoute] GetSocialMediaByIdQuery getByIdSocialMediaQuery)
    {
